  ...
  const features = [
    {
      ...
      description: 'Translate business ideas into clear product roadmaps through requirement analysis, feasibility assessment, and technical planning.',
    },
    {
      icon: <HiCube className="w-7 h-7" />,
      title: 'Architecture & Design',
      description: 'Design scalable, secure, and modular system architectures that support performance, growth, and long term maintainability.',
    },
    {
      icon: <HiCode className="w-7 h-7" />,
      title: 'Product Development',
      description: 'Build high quality software products using modern frameworks, best engineering practices, and agile delivery models.',
    },
    {
      icon: <HiShieldCheck className="w-7 h-7" />,
      title: 'Quality Engineering',
      description: 'Ensure product stability and reliability through comprehensive testing covering functionality, performance, and security.',
    },
    {
      icon: <HiUpload className="w-7 h-7" />,
      title: 'Deployment & Release Management',
      description: 'Manage smooth product releases with controlled deployment, versioning, and rollback strategies.',
    },
    {
      icon: <HiRefresh className="w-7 h-7" />,
      title: 'Product Evolution & Support',
      description: 'Continuously enhance products with new features, performance improvements, and long term support to meet evolving market needs.',
    },
  ];
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-16">
          ...
          >
            <p className="text-gray-700 leading-relaxed text-base md:text-lg font-medium">
              Product engineering at K Labs focuses on building reliable, scalable, and high performance software products aligned to business goals and user needs. Organizations often face challenges moving from concept to market while maintaining quality, security, and adaptability.
            </p>
            <p className="text-gray-700 leading-relaxed text-base md:text-lg font-medium">
              K Labs partners with clients across the product life cycle from idea and architecture to development, deployment, and continuous improvement ensuring products remain robust, relevant, and future ready.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-normal text-gray-900 mb-3 font-semibold">
              What Product Engineering Delivers at K Labs
            </h2>
