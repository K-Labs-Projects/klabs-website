  ...
  const features = [
    {
      ...
      description: 'Identify high impact AI/ML use cases and assess data readiness, risks, and expected outcomes.',
    },
    {
      icon: <HiDatabase className="w-7 h-7" />,
      title: 'Data Preparation & Feature Engineering',
      description: 'Prepare high quality datasets and features required for accurate and reliable model development.',
    },
    {
      icon: <HiCog className="w-7 h-7" />,
      title: 'Model Development & Validation',
      description: 'Develop and validate machine learning models using appropriate algorithms, performance metrics, and testing methods.',
    },
    {
      icon: <HiDocumentText className="w-7 h-7" />,
      title: 'Explainability & Governance',
      description: 'Ensure transparency, traceability, and compliance through model explainability, monitoring, and governance controls.',
    },
    {
      icon: <HiCloud className="w-7 h-7" />,
      title: 'Deployment & Integration',
      description: 'Deploy AI/ML models into production environments and integrate them seamlessly with enterprise systems.',
    },
    {
      icon: <HiChartBar className="w-7 h-7" />,
      title: 'Monitoring & Continuous Improvement',
      description: 'Monitor model performance, accuracy, and drift, and continuously refine models to maintain effectiveness over time.',
    },
  ];
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-16">
          ...
          >
            <p className="text-gray-700 leading-relaxed text-base md:text-lg font-medium">
              AI and Machine Learning at K Labs focus on solving practical business and operational challenges using intelligent systems. Many organizations struggle to move beyond experimentation due to data gaps, integration issues, and lack of governance.
            </p>
            <p className="text-gray-700 leading-relaxed text-base md:text-lg font-medium">
              K Labs designs, builds, and deploys AI/ML solutions that are reliable, explainable, and production ready, integrated securely into existing systems and aligned with organizational objectives.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-normal text-gray-900 mb-3 font-semibold">
              What AI / ML Solutions Deliver at K Labs
            </h2>
