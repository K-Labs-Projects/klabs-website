...
const KnowledgeSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-orange-50 via-white to-orange-50/50 py-16 md:py-20 overflow-hidden">
...
const StatCard = ({ stat, index, isInView }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100/50"
    >
      ...
      <div className="relative z-10">
        <h3 className="text-4xl md:text-5xl lg:text-6xl font-light bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 bg-clip-text text-transparent mb-3 font-sans">
        ...
        <motion.div
          ...
          className="h-[2px] bg-gradient-to-r from-orange-500 to-orange-600 mt-4"
        ></motion.div>
      </div>
    </motion.div>
  );
